...
# ---------------- Komodor API key variables ----------------

# Exact AKS cluster name => Komodor API key
variable "komodor_api_keys_by_cluster" {
  description = "Map of AKS cluster name => Komodor API key"
  type        = map(string)
  sensitive   = true
  default     = {}
}
